...
const AnzeigeDetailInner: React.FC = () => {
  ...
  async function handleBewerben() {
    ...
    try {
      ...
      const newBew = await databases.createDocument<Bewerbung>(
        DB_LEHRSTELLEN,
        COL_BEWERBUNGEN,
        ID.unique(),
        {
          ...
          nachricht: zeitraumBegrenzen && eigeneVon && eigeneBis
            ...
            : nachricht.trim(),
          status: istTalent ? "ausstehend_freigabe" : "ausstehend",  // Freigabe nur fuer Azubi-Bewerbungen
      ...
      <IonContent fullscreen className="ion-padding">
        ...
        {item && (
          <>
            ...
            {!istEigeneAnzeige && !eigeneBewerbung && !istVerbundbuero && (
              <IonCard>
                <IonCardHeader>
